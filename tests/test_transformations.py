...
class TestApplyAllTransformations:
    ...
    def test_trim_and_case_together(self, messy_df):
        out, _, _ = apply_all_transformations(
            messy_df, {'trim': True, 'text_case': 'upper'}
        )
    ...
    def test_dates_are_normalized(self, messy_df):
        out, _, _ = apply_all_transformations(
            messy_df, {'dates': True, 'date_format': 'yyyy-mm-dd'}
        )
    ...
    def test_matches_the_individual_helpers(self, messy_df):
        ...
        combined, _, _ = apply_all_transformations(
            messy_df, {'trim': True, 'text_case': 'title'}
        )
